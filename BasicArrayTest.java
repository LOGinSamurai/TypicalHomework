//все вроде бы сделал но вот только ператор иф в 29 той строке почуму то всегда выдет false
//и сканнер в 42 рой так же не работает, что как бы рушит всю программу)
